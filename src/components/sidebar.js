...
function DrawerExample({filterValue, user, setUser, setFilterValue, token, setToken, currentUser, setCurrentUser}) {
    ...
    return (
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      {!token ? <span style={{fontSize : '27px', fontFamily : 'IBM Plex Mono, monospace'}}>Login to continue</span> : <><span className="question" style={{fontSize : "23px", fontStyle : 'oblique'}}><b>What <span style={{opacity : '.5'}}><i><s>should</s></i></span> will we do <span style={{opacity : '.5'}}><s><i>today</i></s></span> right now?</b></span></>}
    </div>
              ...
              <FormLabel>First Name</FormLabel>
                  ...
                  <FormLabel>Home Address</FormLabel>
                    ...
                    <Login value={imageURL} onChange={()=> {
                      localStorage.setItem(imageURL.toString());
